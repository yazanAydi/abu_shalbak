 ...
 * @param {{ title: string, subtitle?: string, columns: object[], rows: object[], summary?: { label: string, value: string }[], filename?: string, meta?: string[], disabled?: boolean, getExportRows?: () => Promise<object[]> }} props
 */
