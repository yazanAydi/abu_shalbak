...
/**
 * Cashier shift close. Money totals stay in the office; the cashier only sends the shift for the manager to count.
 * @param {object} props
 ...
 */
export default function ShiftEnd({ shiftId, suspendedCount = 0, open, onClose, onSuccess }) {
  ...
  return (
    <div className="shift-modal-overlay" role="dialog" aria-modal="true" dir="rtl" lang="ar">
      ...
      <form className="shift-modal-panel" onSubmit={submitEnd}>
        ...
        <p className="shift-modal-hint">سيقوم المدير بعد النقد في الدرج وإغلاق الوردية نهائياً.</p>
