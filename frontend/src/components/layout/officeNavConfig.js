...
export const OFFICE_NAV = [
  ...
  },
  {
    ...
    label: "موافقات دفعات الموردين",
    icon: "vouchers",
    section: "operations",
    badgePath: "/supplier-payment-approvals",
    permissionKey: "suppliers",
    omitFromPermissionTopics: true,
    visible: navVisible("suppliers"),
  },
  {
    ...
    label: "موافقات مصاريف المحل",
    icon: "vouchers",
    section: "operations",
    badgePath: "/shop-consumption-approvals",
    permissionKey: "expenses",
    omitFromPermissionTopics: true,
    visible: navVisible("expenses"),
  },
...
export const ROUTE_TITLES = {
  ...
  "/supplier-payment-approvals": "موافقات دفعات الموردين",
  "/shop-consumption-approvals": "موافقات مصاريف المحل",
