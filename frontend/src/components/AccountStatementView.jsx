...
export default function AccountStatementView({ report, partyType }) {
  ...
  return (
    <div className="statement-view hesabati-statement account-statement-view">
      <img
        className="hesabati-statement__logo"
        src={resolveStoreLogoUrl()}
        alt=""
      />
      <div className="hesabati-statement__store">{report.store_name || STORE_NAME_AR}</div>
      <div className="hesabati-statement__store-sub">{report.store_phone || STORE_PHONE}</div>
      <div className="hesabati-statement__store-sub">{report.store_license || STORE_LICENSE_LINE}</div>
