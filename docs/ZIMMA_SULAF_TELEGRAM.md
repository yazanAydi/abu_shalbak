...
# اختياري: معرّفات تيليجرام المسموح لها بالموافقة (مفصولة بفاصلة).
# إذا تُرك فارغاً يُقبل أي ضغط داخل مجموعة المدير.
...
- المصادقة الافتراضية على مستوى المجموعة (`TELEGRAM_*_CHAT_ID` / `TELEGRAM_MANAGER_CHAT_ID`). القائمة الاختيارية `TELEGRAM_MANAGER_USER_IDS` تقيّد الموافقة بمعرّفات تيليجرام محددة عند تعبئتها.
