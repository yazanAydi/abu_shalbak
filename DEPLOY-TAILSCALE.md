...
- POS complete-sale is **F9** (not F12). F12 is Edge DevTools and must stay unbound. After a rebuild, hard-reload (`Ctrl+F5`). Cashier printing: `docs/RECEIPT_BROWSER_PRINT.md`.
