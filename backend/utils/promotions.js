 ...
 *   multi_price  -> buy_qty units for discount_value total (e.g. 2 for 10₪)
 */
 ...
 * @param {Array<{product_id:number, product_unit_id?:number, category?:string, quantity:number, unitPrice:number}>} lines
